    <a href="<?php echo $cart; ?>" class="hand">
<div id="cart" class="btn-group btn-block hand displayInline">

  <?php //echo $text_items; ?>
    <div id="mycart" style="position: absolute; color: red; top: 5px; right: 6px"><?php echo $count_items; ?></div>
</span><img width="20px" height="20px" style="position: relative;" src="<?php echo $img_cart_src; ?>" >
