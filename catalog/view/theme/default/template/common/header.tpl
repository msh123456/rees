...
<head>
	...
	<?php } ?>
	<?php if ($direction == 'rtl') { ?>
       <link href="catalog/view/theme/default/stylesheet/stylesheet-rtl.css" type="text/css" rel="stylesheet">
       <link href="catalog/view/theme/default/stylesheet/c1.css" type="text/css" rel="stylesheet">
	<?php } else { ?>
...
<header>
        ...
        <nav class="navbar navbar-default mynavbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <div class="input-group hidden-lg hidden-md hidden-sm" style="width: 200px; float: left; left: 25px; top: 8px;">
                        <button style="float: left;" class="btn searchBtn" type="submit">
                            <span class="glyphicon glyphicon-search"></span>
                        </button>
                        <input style="width: 100px; float: left; padding-top: 6px" type="text" id="search_header2" onkeyup="searchAjax2()"
                               onfocus="searchAjax2(1); $(this).attr('data-default', $('#search_header2').width()); $('#search_header2').animate({ width: 150 }, 'slow');"
                               onblur="$('#searchResult2').fadeOut(300); var w = $(this).attr('data-default');  $('#search_header2').animate({ width: w }, 'slow');"
                               class="dropdown-toggle searchInput"
                               placeholder="جستجو">
                        <ul id="searchResult2" class="results2 dropdown-menu header-dropdown-menu2">
                    ...
                    <ul class="nav navbar-nav header-navbar-nav">
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#"
                               onclick="if($(window).width()>660) {location.href='<?= $server ?>/index.php?route=product/category&path=59';}">کلکسیون</a>
    ...
    <script>
        ...
        function searchAjax2(isfocus=0) {
            ...
            var searchText = $("#search_header2").val();
            if (isfocus == 1 && searchText != "") {
                $('#searchResult2').fadeIn(0);
            ...
            if (searchText != "") {
                ...
                $('#searchResult2').html("<div class='text-center'> <img src='image/sal.gif'></div>");
                $('#searchResult2').fadeIn(0);
            } else if (searchText == "") {


                $('#searchResult2').fadeOut(0);
                return;
            }
            globalTimeout = setTimeout(function () {
