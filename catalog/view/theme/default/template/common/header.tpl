            ...
            <div style="background-color: white;" id="fixed">
                        ...
                        <div class="hand pull-left">
                            ...
                            <?php if (!$islogin): ?>
                                <div class="dropdown displayInline">
                                    <img class="marginok" data-toggle="dropdown" width="20px" height="20px" src="<?php echo $user_icon; ?>" />
                                    <div class="dropdown-menu topLogin text-justify" >
                                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <?php } ?>
                                            با ایجاد یک حساب کاربری میتوانید سریع تر خرید نمایید. تاریخچه سفارشات خود را دیده و همچنین از وضعیت سفارش خود آگهی پیدا نمایید.
                                            <input value="<?php echo $text_register; ?>" type="button" class="mybtn" onclick="location.href = '<?php echo $register; ?>'">
                                        </form>
                                    </div>
                                </div>
                            <?php else: ?>
                                <a href="<?php echo $account_url; ?>"><img width="20px" height="20px" src="<?php echo $user_icon; ?>" />  درود  <?php echo $firstname; ?>  </a> | 
                ...
                <div id="logo">
                    <?php if ($logo) { ?>
                        ...
                        <img id="logo_img" src="<?php echo $logofix; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" />
                        <!--</a>-->
                    <?php } else { ?>
                ...
                <div id="menuDiv" class="text-center" style="height:40px">
                    ...
                    <div class="dummy dropdown myP" id="current2">
                        ...
                        <div class="dropdown-menu myDropDown">
                            <div class="row">
                                <div class="col-md-5">
                                    <div onmouseover="$('#rahnamayekharidImg').attr('src', '<?php echo $server . 'image/catalog/test.jpg'; ?>');"><a href="<?php echo $server; ?>index.php?route=information/information&information_id=5">نحوه سفارش </a></div>
                                    <div onmouseover="$('#rahnamayekharidImg').attr('src', '<?php echo $server . 'image/catalog/test2.jpg'; ?>');"><a href="<?php echo $server; ?>index.php?route=information/information&information_id=9">شرایط ارسال</a></div>
                    ...
                    <a href="<?php echo $server; ?>index.php?route=information/information&information_id=4" onclick="doheightMenu()" class="myP">درباره ما</a>
                    <form class="myP" method="get" action="<?php echo $server; ?>index.php?route=">
                        <img width="18px" src="<?php echo $search_icon; ?>">
                        <input type="hidden" name="route" value="product/search" >
                        <input id="search_header" name="search" type="text" class="myInput" placeholder="جستجو">
