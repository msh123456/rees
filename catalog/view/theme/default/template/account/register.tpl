...
<div id="mycontainer" class="container">
    ...
    <?php } ?>
    <div class="p2_top register_bread">
        <div class="col-sm-12">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal register_form">
            <fieldset id="account">
              <!--<legend><?php echo $text_your_details; ?></legend>-->
                ...
                <div class="form-group required">
                    ...
                    <div class="">
                        <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-firstname" class="form-control register_input" />
                ...
                <div class="form-group required">
                    ...
                    <div class="">
                        <input type="text" name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-lastname" class="form-control register_input" />
                ...
                <div class="form-group required">
                    ...
                    <div class="">
                        <input type="email" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control register_input" />
                        <?php if ($error_email) { ?>
                ...
                <div class="form-group required">
                    ...
                    <div class="">
                        <input type="tel" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control register_input" />
                ...
                <div class="form-group required">
                    ...
                    <div class="">
                        <input type="tel" name="mobile" value="<?php echo $mobile; ?>" placeholder="<?php echo $entry_mobile; ?>" id="input-mobile" class="form-control register_input" />
                        <?php if ($error_mobile) { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        <input type="text" name="fax" value="<?php echo $fax; ?>" placeholder="<?php echo $entry_fax; ?>" id="input-fax" class="form-control register_input" />
                    </div>
                </div>
                    ...
                    <?php if ($custom_field['location'] == 'account') { ?>
                        <?php if ($custom_field['type'] == 'select') { ?>
                            <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                                ...
                                <div class="">
                                    <select name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control register_input">
                        ...
                        <?php if ($custom_field['type'] == 'textarea') { ?>
                            <div id="custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                                <label class="control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
                                <div class="">
                                    <textarea name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control register_input"><?php echo (isset($register_custom_field[$custom_field['custom_field_id']]) ? $register_custom_field[$custom_field['custom_field_id']] : $custom_field['value']); ?></textarea>
                                    <?php if (isset($error_custom_field[$custom_field['custom_field_id']])) { ?>
                                        <div class="text-danger"><?php echo $error_custom_field[$custom_field['custom_field_id']]; ?></div>
                                    <?php } ?>
                                </div>
            ...
            <fieldset id="address">
              <!--<legend><?php echo $text_your_address; ?></legend>-->
                <!--        <div class="form-group">
                          ...
                          <div class="">
                            <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-company" class="form-control register_input" />
                          </div>
                        </div>-->
                <div class="form-group required">
                    <label class=" control-label" for="input-address-1"><?php echo $entry_address_1; ?></label>
                    <div class="">
                        <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-address-1" class="form-control register_input" />
                ...
                <div class="form-group">
                    ...
                    <div class=" ">
                        <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-address-2" class="form-control register_input" />
                    </div>
                </div>
                <div class="form-group required">
                    <label class="  control-label" for="input-city"><?php echo $entry_city; ?></label>
                    <div class=" ">
                        <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-city" class="form-control register_input" />
                        <?php if ($error_city) { ?>
                ...
                <div class="form-group required">
                    ...
                    <div class=" ">
                        <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control register_input" />
                ...
                <div class="form-group required">
                    ...
                    <div class=" ">
                        <select name="country_id" id="input-country" class="form-control register_input">
                            <option value=""><?php echo $text_select; ?></option>
                ...
                <div class="form-group required">
                    ...
                    <div class=" ">
                        <select name="zone_id" id="input-zone" class="form-control register_input">
                        </select>
                        <?php if ($error_zone) { ?>
            ...
            <fieldset>
                ...
                <div class="form-group required">
                    ...
                    <div class=" ">
                        <input type="password" name="password" value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-password" class="form-control register_input" />
                ...
                <div class="form-group required">
                    ...
                    <div class=" ">
                        <input type="password" name="confirm" value="<?php echo $confirm; ?>" placeholder="<?php echo $entry_confirm; ?>" id="input-confirm" class="form-control register_input" />
