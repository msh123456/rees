        ...
        <div class="row">
            <?php foreach ($products as $product) : ?>
                ...
                <div onmouseout="hide('.ctext<?php echo $product['product_id']; ?>');
                    ...
                    <div style="display: none;" class="text-center ctext<?php echo $product['product_id']; ?>"
                         id="text">
                        <div id="child">
                    ...
                    <div style="line-height: 40px;" class="text-center" id="sm<?php echo $product['product_id']; ?>">
                        سایزهای موجود
                    </div>
                </div>
            <?php endforeach; ?>
